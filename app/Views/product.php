...
<section class="text-gray-600 body-font overflow-hidden">
  <div class=" px-5 py-24 flex items-center justify-center ">
    <div class=" flex gap-16 items-center justify-center">
      <img alt="ecommerce" class="w-80 h-96 " src="data:image/jpeg;base64,<?php echo base64_encode($product['image']); ?>">
      <div class="w-96">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">SMART WATCH</h2>
